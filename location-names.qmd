...
To ensure consistency across the dataset, we algorithmically estimated these fields based on the core's location. This page outlines the data sources and geospatial methods used to populate the `country`, `municipality`, and `sea_name` columns in the [station](db-schema.qmd#station) table.
