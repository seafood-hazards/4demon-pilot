...
subtitle: "Cleaning and translating the 4Demon dataset"
---
...
This page documents the data preparation steps applied to the raw 4Demon export before loading it into the pilot SQLite database. All German field names and coded values are translated to English to ensure consistency with the ICES-DOME dataset.
