...
function fmtVal(v) {
  return v == null ? "N/A" : v.toFixed(0) + " µg/g"
}
  ...
  if (legendEl) {
    ...
    legendEl.innerHTML = `
      ...
      <div style="font-size:11px;color:#555">
        Avg (µg/g) · ${year_start}–${year_end} · ${organisationLabel}
      </div>
...
map_data.length === 0
  ...
  : md`**${selected_element.label}** · ${year_start}–${year_end} · ${selected_project} · **${map_data.length}** locations · values in µg/g`
```
